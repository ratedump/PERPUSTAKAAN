...
@section('isihalaman')
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalAnggotaTambah" style="background:#747264"> 
        Tambah Data anggota
    </button>
            ...
            @foreach ($anggota as $index=>$a)
                <tr>
                    ...
                    <td align="center">
                        ...
                        <div class="modal fade" id="modalAnggotaEdit{{$a->id_anggota}}" tabindex="-1" role="dialog" aria-labelledby="modalAggotaEditLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form name="formanggotaedit" id="formanggotaedit" action="/anggota/edit/{{ $a->id_anggota}} " method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <label for="id_anggota" class="col-sm-4 col-form-label">Kode Anggota</label>
                                                <div class="col-sm-8">
    ...
    <div class="modal fade" id="modalAnggotaTambah" tabindex="-1" role="dialog" aria-labelledby="modalAnggotaTambahLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAnggotaTambahLabel">Form Input Data Buku</h5>
                </div>
                <div class="modal-body">
